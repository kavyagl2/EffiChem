...
train_path = ".../transformer_CH_finetuned/bbbp_train_embed.csv"
test_path = ".../transformer_CH_finetuned/bbbp_test_embed.csv"
val_path = ".../transformer_CH_finetuned/bbbp_eval_embed.csv"
